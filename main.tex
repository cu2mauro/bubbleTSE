...
\documentclass[binding=0.6cm, a4paper]{unifith}
...
\begin{figure}[htbp]
\centering
    \includegraphics[width=.4\textwidth]{download.png}
\qquad
    \includegraphics[width=.4\textwidth]{trasferimento (1).png}
\qquad
    \includegraphics[width=.4\textwidth]{trasferimento (2).png}
\qquad
    \includegraphics[width=.4\textwidth]{trasferimento (3).png}
\qquad
    \includegraphics[width=.4\textwidth]{trasferimento.png}
    \qquad
